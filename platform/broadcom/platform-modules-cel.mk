...
CEL_GREYSTONE_PLATFORM_MODULE_VERSION = 0.9
...
export CEL_GREYSTONE_PLATFORM_MODULE_VERSION
...
CEL_GREYSTONE_PLATFORM_MODULE = platform-modules-greystone_$(CEL_GREYSTONE_PLATFORM_MODULE_VERSION)_amd64.deb
$(CEL_GREYSTONE_PLATFORM_MODULE)_PLATFORM = x86_64-cel_ds4101-r0
$(eval $(call add_extra_package,$(CEL_DX010_PLATFORM_MODULE),$(CEL_GREYSTONE_PLATFORM_MODULE)))
